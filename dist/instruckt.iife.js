/* instruckt v0.1.1 | MIT */
"use strict";var Instruckt=(()=>{var v=Object.defineProperty;var K=Object.getOwnPropertyDescriptor;var U=Object.getOwnPropertyNames,M=Object.getOwnPropertySymbols;var T=Object.prototype.hasOwnProperty,Y=Object.prototype.propertyIsEnumerable;var $=(i,t,e)=>t in i?v(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,z=(i,t)=>{for(var e in t||(t={}))T.call(t,e)&&$(i,e,t[e]);if(M)for(var e of M(t))Y.call(t,e)&&$(i,e,t[e]);return i};var V=(i,t)=>{for(var e in t)v(i,e,{get:t[e],enumerable:!0})},J=(i,t,e,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of U(t))!T.call(i,o)&&o!==e&&v(i,o,{get:()=>t[o],enumerable:!(n=K(t,o))||n.enumerable});return i};var W=i=>J(v({},"__esModule",{value:!0}),i);var pt={};V(pt,{Instruckt:()=>f,init:()=>ct});function X(){let i=document.cookie.match(/(?:^|;\s*)XSRF-TOKEN=([^;]+)/);return i?decodeURIComponent(i[1]):""}function b(){let i={"Content-Type":"application/json",Accept:"application/json"},t=X();return t&&(i["X-XSRF-TOKEN"]=t),i}var k=class{constructor(t){this.endpoint=t}async createSession(t){let e=await fetch(`${this.endpoint}/sessions`,{method:"POST",headers:b(),body:JSON.stringify({url:t})});if(!e.ok)throw new Error(`instruckt: failed to create session (${e.status})`);return e.json()}async getSession(t){let e=await fetch(`${this.endpoint}/sessions/${t}`,{headers:{Accept:"application/json"}});if(!e.ok)throw new Error(`instruckt: failed to get session (${e.status})`);return e.json()}async addAnnotation(t,e){let n=await fetch(`${this.endpoint}/sessions/${t}/annotations`,{method:"POST",headers:b(),body:JSON.stringify(e)});if(!n.ok)throw new Error(`instruckt: failed to add annotation (${n.status})`);return n.json()}async updateAnnotation(t,e){let n=await fetch(`${this.endpoint}/annotations/${t}`,{method:"PATCH",headers:b(),body:JSON.stringify(e)});if(!n.ok)throw new Error(`instruckt: failed to update annotation (${n.status})`);return n.json()}async addReply(t,e,n="human"){let o=await fetch(`${this.endpoint}/annotations/${t}/reply`,{method:"POST",headers:b(),body:JSON.stringify({role:n,content:e})});if(!o.ok)throw new Error(`instruckt: failed to add reply (${o.status})`);return o.json()}};var y=class{constructor(t,e,n){this.endpoint=t;this.sessionId=e;this.onUpdate=n;this.source=null}connect(){this.source||(this.source=new EventSource(`${this.endpoint}/sessions/${this.sessionId}/events`),this.source.addEventListener("annotation.updated",t=>{try{let e=JSON.parse(t.data);this.onUpdate(e)}catch(e){}}),this.source.onerror=()=>{})}disconnect(){var t;(t=this.source)==null||t.close(),this.source=null}};var D=`
body.ik-annotating,
